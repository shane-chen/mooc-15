...
public interface VideoSvcApi {
	...
	public static final String VIDEO_RATING_PATH = VIDEO_SVC_PATH + "/{" + ID_PARAMETER + "}/{" + RATING_PARAMETER + "}";

	@GET(VIDEO_RATING_PATH)
	public float updateRating(@Path(ID_PARAMETER) long id, @Path(RATING_PARAMETER) float rating);
